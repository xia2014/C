...
//#define FIFO_RRST_H()   GPIOC->BSRR =GPIO_Pin_8
//#define FIFO_RRST_L()   GPIOC->BRR  =GPIO_Pin_8

#define FIFO_RRST_H()   GPIOC->BSRR =GPIO_Pin_10
#define FIFO_RRST_L()   GPIOC->BRR  =GPIO_Pin_10
